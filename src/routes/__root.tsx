...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "A premium AI operating system for modern workplace productivity." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "AI Workplace Productivity Assistant" },
      { name: "twitter:description", content: "A premium AI operating system for modern workplace productivity." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/91c3f4e3-1dc7-4dd3-ba93-2e7b909340fb/id-preview-95661d20--f0d9c8a6-1feb-441e-acad-3ebc128453e1.lovable.app-1778751458234.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/91c3f4e3-1dc7-4dd3-ba93-2e7b909340fb/id-preview-95661d20--f0d9c8a6-1feb-441e-acad-3ebc128453e1.lovable.app-1778751458234.png" },
    ],
    links: [
